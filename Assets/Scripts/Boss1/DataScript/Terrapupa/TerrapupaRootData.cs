...
{
    [Title("사운드 설정")] [InfoBox("일어날 때 소리")]
    public string sound1 = "TerrapupaGripStone";

    [Title("기본 수치")] [InfoBox("보스 이름")] public string bossName;

    [InfoBox("보스의 체력")] public int hp = 20;

    [Title("패턴 사용 여부")] [InfoBox("구르기")] public bool rollUsable = true;
    ...
    [Title("공격 감지 범위")] [InfoBox("장거리 공격")]
    public float LongRangeDetectionDistance = 25.0f;
